...
export default function GitHubLink({ href, label = 'View on GitHub' }: GitHubLinkProps) {
  return (
    <a
      href={href}
      target="_blank"
      rel="noopener noreferrer"
      className="inline-flex items-center gap-1.5 bg-amber-950 px-3 py-2 text-xs font-bold uppercase tracking-wider text-amber-100 transition-colors hover:bg-amber-900 hover:text-white"
      aria-label={label}
    >
      <svg
        viewBox="0 0 24 24"
